  ...
  return (
    <section ref={statsRef} className="relative section-padding-large bg-gradient-to-br from-white via-blue-50/20 to-emerald-50/20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-400/10 to-purple-500/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-br from-emerald-400/10 to-teal-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-indigo-400/10 to-blue-500/10 rounded-full blur-3xl animate-morphing" />
        <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-gradient-to-br from-amber-400/10 to-orange-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }} />
      </div>
